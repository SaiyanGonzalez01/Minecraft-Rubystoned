...
cp target_teavm_javascript/javascript/EaglercraftX_1.8_Offline_International.html client/Rubystoned_Offline_JS.html
...
cp target_teavm_wasm_gc/javascript_dist/EaglercraftX_1.8_WASM-GC_Offline_Download.html client/Rubystoned_Offline_WASM.html
