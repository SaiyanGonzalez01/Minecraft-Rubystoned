...
public final class GuiIngame extends Gui {
	...
	public final void renderGameOverlay(float var1) {
		...
		if (this.mc.options.showFPS) {
			...
			var23 = this.mc;
			var4.drawStringWithShadow(
					"P: " + var23.effectRenderer.getStatistics() + ". T: " + var23.theWorld.debugSkylightUpdates(), 2, 32,
					16777215);
			...
			if (this.mc.options.showFramerate)
				var4.drawStringWithShadow("Minecraft Rubystoned (" + this.mc.fps + " fps)", 2, 2, 16777215);
			else
				var4.drawStringWithShadow("Minecraft Rubystoned", 2, 2, 16777215);
			if (this.mc.options.showCoords)
				var4.drawStringWithShadow("x: " + (int) Math.floor(this.mc.thePlayer.posX) + ", y: "
