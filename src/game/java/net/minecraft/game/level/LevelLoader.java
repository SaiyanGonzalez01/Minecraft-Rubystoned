...
public abstract class LevelLoader {
	...
	public final World load(InputStream var1) throws IOException {
		...
		for (int var18 = 0; var18 < var17.tagCount(); ++var18) {
			try {
				...
				Object var20 = var14.equals("Chest") ? new TileEntityChest()
						: (var14.equals("Furnace") ? new TileEntityFurnace() : null);
				if (var20 != null) {
	...
	protected Entity loadEntity(World var1, String var2) {
		return (Entity) (var2.equals("Pig") ? new EntityPig(var1)
				: (var2.equals("Sheep") ? new EntitySheep(var1)
						: (var2.equals("Creeper") ? new EntityCreeper(var1)
								: (var2.equals("Skeleton") ? new EntitySkeleton(var1)
										: (var2.equals("Spider") ? new EntitySpider(var1)
	...
	public final void save(World var1, OutputStream var2) throws IOException {
		...
		DataOutputStream var14 = new DataOutputStream(EaglerZLIB.newGZIPOutputStream(var2));
