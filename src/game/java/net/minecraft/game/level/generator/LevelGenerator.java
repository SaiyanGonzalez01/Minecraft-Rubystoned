	...
	public final World generate(String var1, int var2, int var3, int var4) {
		...
		for (var7 = 0; var7 < var5; ++var7) {
			...
			if (this.flatGen) {
				...
				this.loadingBar();
				var9 = this;
				NoiseGeneratorDistort var10 = new NoiseGeneratorDistort(new NoiseGeneratorOctaves(this.rand, 8),
						new NoiseGeneratorOctaves(this.rand, 8));
				NoiseGeneratorDistort var11 = new NoiseGeneratorDistort(new NoiseGeneratorOctaves(this.rand, 8),
						new NoiseGeneratorOctaves(this.rand, 8));
				...
				label349: while (true) {
					if (var22 >= var9.width) {
						...
						var46 = var14;
						var9 = this;
						var11 = new NoiseGeneratorDistort(new NoiseGeneratorOctaves(this.rand, 8),
								new NoiseGeneratorOctaves(this.rand, 8));
						NoiseGeneratorDistort var50 = new NoiseGeneratorDistort(new NoiseGeneratorOctaves(this.rand, 8),
								new NoiseGeneratorOctaves(this.rand, 8));
						var52 = 0;
					...
					for (var25 = 0; var25 < var9.depth; ++var25) {
						...
						double var28 = var10.generateNoise((double) ((float) var22 * 1.3F), (double) ((float) var25 * 1.3F)) / 6.0D
								+ -4.0D;
						double var30 = var11.generateNoise((double) ((float) var22 * 1.3F), (double) ((float) var25 * 1.3F)) / 5.0D
								+ 10.0D + -4.0D;
						...
						if (var9.islandGen) {
							...
							double var39 = var13.generateNoise((double) ((float) var22 * 0.05F), (double) ((float) var25 * 0.05F))
									/ 4.0D + 1.0D;
			...
			for (var21 = 0; var21 < var49; ++var21) {
				...
				for (var22 = 0; var22 < var51; ++var22) {
					...
					if ((var67 == Block.waterMoving.blockID || var67 == Block.waterStill.blockID || var67 == 0)
							&& var25 <= var9.waterLevel - 1 && var61) {
					...
					for (var5 = (int) (var74 - var78); var5 <= (int) (var74 + var78); ++var5) {
						for (int var81 = (int) (var33 - var78); var81 <= (int) (var33 + var78); ++var81) {
							for (int var40 = (int) (var77 - var78); var40 <= (int) (var77 + var78); ++var40) {
								...
								if (var41 < var78 * var78 && var5 > 0 && var81 > 0 && var40 > 0 && var5 < var9.width - 1
										&& var81 < var9.height - 1 && var40 < var9.depth - 1) {
...
>>>>>>> 82abaf8552aa45e8355877fdb10070bc66ca2896
		...
		for (int var4 = var1 - 3; var4 <= var1 + 3; ++var4) {
			for (int var5 = var2 - 2; var5 <= var2 + 2; ++var5) {
				for (int var6 = var3 - 3; var6 <= var3 + 3; ++var6) {
					...
					if (var4 == var1 - 3 || var6 == var3 - 3 || var4 == var1 + 3 || var6 == var3 + 3 || var5 == var2 - 2
							|| var5 == var2 + 2) {
		...
		for (int var2 = 0; var2 < this.width; ++var2) {
			...
			for (int var3 = 0; var3 < this.height; ++var3) {
				for (int var4 = 0; var4 < this.depth; ++var4) {
					if (var1.getBlockId(var2, var3, var4) == Block.dirt.blockID
							&& var1.getBlockLightValue(var2, var3 + 1, var4) >= 4
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			...
			for (int var8 = 0; var8 < 10; ++var8) {
				...
				for (int var12 = 0; var12 < 10; ++var12) {
					...
					if (var9 >= 0 && var11 >= 0 && var10 > 0 && var9 < this.width && var11 < this.depth && var10 < this.height
							&& var1.getBlockId(var9, var10, var11) == 0 && var2.canBlockStay(var1, var9, var10, var11)) {
	...
	private void lavaGen() {
		...
		for (int var3 = 0; var3 < var1; ++var3) {
			...
			int var4 = this.rand.nextInt(this.width);
			int var5 = Math.min(Math.min(this.rand.nextInt(var2), this.rand.nextInt(var2)),
					Math.min(this.rand.nextInt(var2), this.rand.nextInt(var2)));
			int var6 = this.rand.nextInt(this.depth);
			if (this.blocksByteArray[(var5 * this.depth + var6) * this.width + var4] == 0) {
				long var7 = this.floodFill(var4, var5, var6, 0, 255);
				if (var7 > 0L && var7 < 640L) {
	...
	private long floodFill(int var1, int var2, int var3, int var4, int var5) {
		...
		while (var23 > 0) {
			...
			if (var5 == 255 && (var16 == 0 || var17 == this.width - 1 || var13 == 0 || var13 == this.height - 1 || var3 == 0
					|| var3 == this.depth - 1)) {
				return -1L;
			}
			...
			for (var16 = var16; var16 < var17; ++var16) {
				...
				if (var13 > 0) {
					...
					if ((var6 == Block.lavaMoving.blockID || var6 == Block.lavaStill.blockID)
							&& (var26 == Block.waterMoving.blockID || var26 == Block.waterStill.blockID)) {
