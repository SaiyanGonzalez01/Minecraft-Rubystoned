...
public final class World {
		...
		for (var2 = 0; var2 < this.width; ++var2) {
			for (var6 = 0; var6 < this.length; ++var6) {
				for (var7 = 0; var7 < this.height; ++var7) {
					int var8 = 0;
					if (var7 <= 1 && var7 < this.groundLevel - 1
							&& var4[((var7 + 1) * this.length + var6) * this.width + var2] == 0) {
		...
		if (var5 == null) {
			...
			for (var3 = 0; var3 < var11.width; ++var3) {
				for (int var12 = 0; var12 < var11.length; ++var12) {
					int var13;
					for (var13 = var11.height - 1; var13 > 0
							&& Block.lightOpacity[var11.getBlockId(var3, var13, var12)] == 0; --var13) {
					}
		...
		if (var1 > 0 && var2 > 0 && var3 > 0 && var1 < this.width - 1 && var2 < this.height - 1 && var3 < this.length - 1) {
			if (var4 == this.blocks[(var2 * this.length + var3) * this.width + var1]) {
				...
				if (var4 == 0 && (var1 == 0 || var3 == 0 || var1 == this.width - 1 || var3 == this.length - 1)
						&& var2 >= this.groundLevel && var2 < this.waterLevel) {
				...
				if (Block.lightOpacity[var5] != Block.lightOpacity[var4] || Block.lightValue[var5] != 0
						|| Block.lightValue[var4] != 0) {
	...
	public final void tick() {
		...
		for (var7 = 0; var7 < var6; ++var7) {
			...
			if (var8.scheduledTime > 0) {
				...
				var10 = var8.xCoord;
				if (var10 >= 0 && var11 >= 0 && var12 >= 0 && var10 < this.width && var11 < this.height
						&& var12 < this.length) {
	...
	public final boolean isSolid(float var1, float var2, float var3, float var4) {
		return this.isSolid(var1 - 0.1F, var2 - 0.1F, var3 - 0.1F) ? true
				: (this.isSolid(var1 - 0.1F, var2 - 0.1F, var3 + 0.1F) ? true
						: (this.isSolid(var1 - 0.1F, var2 + 0.1F, var3 - 0.1F) ? true
								: (this.isSolid(var1 - 0.1F, var2 + 0.1F, var3 + 0.1F) ? true
										: (this.isSolid(var1 + 0.1F, var2 - 0.1F, var3 - 0.1F) ? true
												: (this.isSolid(var1 + 0.1F, var2 - 0.1F, var3 + 0.1F) ? true
														: (this.isSolid(var1 + 0.1F, var2 + 0.1F, var3 - 0.1F) ? true
																: this.isSolid(var1 + 0.1F, var2 + 0.1F, var3 + 0.1F)))))));
	}
	...
	private int getFirstUncoveredBlock(int var1, int var2) {
		int var3;
		for (var3 = this.height; (this.getBlockId(var1, var3 - 1, var2) == 0
				|| Block.blocksList[this.getBlockId(var1, var3 - 1, var2)].material == Material.air) && var3 > 0; --var3) {
		}
	...
	public final byte getBlockLightValue(int var1, int var2, int var3) {
		...
		return this.blocks[(var2 * this.length + var3) * this.width + var1] == Block.stairSingle.blockID
				? (var2 < this.height - 1 ? (byte) (this.data[((var2 + 1) * this.length + var3) * this.width + var1] & 15) : 15)
				: (byte) (this.data[(var2 * this.length + var3) * this.width + var1] & 15);
	}
	...
	public final void setBlockMetadata(int var1, int var2, int var3, int var4) {
		...
		this.data[(var2 * this.length + var3) * this.width
				+ var1] = (byte) ((this.data[(var2 * this.length + var3) * this.width + var1] & 15) + (var4 << 4));
...
>>>>>>> 82abaf8552aa45e8355877fdb10070bc66ca2896
		...
		for (int var37 = var35.size() - 1; var37 >= 0; --var37) {
			...
			if (var8 >= 0 && var19 >= 0 && var20 >= 0 && var8 < this.width && var19 < this.height && var20 < this.length) {
				...
				for (var22 = 0; var22 <= 0; ++var22) {
					...
					var7 *= var11;
					var28 *= var11;
					this.spawnParticle("explode", (var43 + var2) / 2.0F, (var27 + var3) / 2.0F, (var24 + var4) / 2.0F, var25,
							var7, var28);
					this.spawnParticle("smoke", var43, var27, var24, var25, var7, var28);
				}

				if (var21 > 0) {
					Block.blocksList[var21].dropBlockAsItemWithChance(this, var8, var19, var20,
							this.getBlockMetadata(var8, var19, var20), 0.3F);
		...
		if (var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width && var2 < this.height && var3 < this.length) {
			...
			label170: do {
				...
				while (true) {
					...
					for (var15 *= var15; var1 > 0 && this.floodFillCounters[var14 - 1] != floodFillCounter
							&& (this.blocks[(var2 * this.length + var3) * this.width + var1 - 1] == var4
									|| this.blocks[(var2 * this.length + var3) * this.width + var1 - 1] == var5); --var14) {
						--var1;
					}
					...
					for (boolean var18 = false; var1 < this.width && this.floodFillCounters[var14] != floodFillCounter
							&& (this.blocks[(var2 * this.length + var3) * this.width + var1] == var4
									|| this.blocks[(var2 * this.length + var3) * this.width + var1] == var5); ++var1) {
						byte var19;
						boolean var22;
						if (var3 > 0) {
	...
	public final int floodFill(int var1, int var2, int var3, int var4, int var5) {
		if (var1 >= 0 && var2 >= 0 && var3 >= 0 && var1 < this.width && var2 < this.height && var3 < this.length) {
			...
			do {
				...
				var1 = var7 % 1024;
				var3 = var7 / 1024;
				if (var1 == 0 || var1 == this.width - 1 || var2 == 0 || var2 == this.height - 1 || var3 == 0
						|| var3 == this.length - 1) {
					return 2;
				}

				while (var1 > 0 && this.floodFillCounters[var7 - 1] != floodFillCounter
						&& (this.blocks[(var2 * this.length + var3) * this.width + var1 - 1] == var4
								|| this.blocks[(var2 * this.length + var3) * this.width + var1 - 1] == var5)) {
					--var1;
					--var7;
				}
				...
				for (boolean var9 = false; var1 < this.width && this.floodFillCounters[var7] != floodFillCounter
						&& (this.blocks[(var2 * this.length + var3) * this.width + var1] == var4
								|| this.blocks[(var2 * this.length + var3) * this.width + var1] == var5); ++var1) {
	...
	public final void extinguishFire(int var1, int var2, int var3, int var4) {
		...
		if (this.getBlockId(var1, var2, var3) == Block.fire.blockID) {
			this.playSoundAtPlayer((float) var1 + 0.5F, (float) var2 + 0.5F, (float) var3 + 0.5F, "random.fizz", 0.5F,
