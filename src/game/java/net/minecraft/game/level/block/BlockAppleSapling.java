...
public final class BlockAppleSapling extends BlockFlower {
	protected BlockAppleSapling(int var1, int var2) {
		super(74, 111, "Apple Sapling");
	...
	public final void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if(var1.getBlockLightValue(var2, var3 + 1, var4) >= 9 && var5.nextInt(5) == 0) {
			...
			if(!var1.growAppleTrees(var2, var3, var4)) {
