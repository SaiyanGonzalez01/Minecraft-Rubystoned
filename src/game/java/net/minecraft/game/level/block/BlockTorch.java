...
public final class BlockTorch extends Block {
	protected BlockTorch(int var1, int var2, String var3) {
		super(50, 80, Material.circuits, var3);
	...
	public final boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
		return var1.isBlockNormalCube(var2 - 1, var3, var4) ? true
				: (var1.isBlockNormalCube(var2 + 1, var3, var4) ? true
						: (var1.isBlockNormalCube(var2, var3, var4 - 1) ? true
								: (var1.isBlockNormalCube(var2, var3, var4 + 1) ? true
	...
	public final MovingObjectPosition collisionRayTrace(World var1, int var2, int var3, int var4, Vec3D var5,
			Vec3D var6) {
		byte var7 = var1.getBlockMetadata(var2, var3, var4);
		if (var7 == 1) {
