...
import net.minecraft.client.gui.container.InventoryCraftResult;
import net.minecraft.client.gui.container.InventoryCrafting;
import net.minecraft.client.gui.container.Slot;
import net.minecraft.client.gui.container.SlotCrafting;
import net.minecraft.client.render.RenderEngine;
import net.minecraft.game.IInventory;
import net.minecraft.game.entity.player.InventoryPlayer;
import net.minecraft.game.item.ItemStack;
import rubystoned.item.recipe.CarvingManager;
...
public final class GuiStonecutter extends GuiContainer {
	...
	public GuiStonecutter(InventoryPlayer var1) {
